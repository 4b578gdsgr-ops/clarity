...
const CUSTOM_BUILD_OPTIONS = {
  frames: [
    { name: 'Moots', country: 'USA (Steamboat Springs, CO)', material: 'Titanium', karma_score: 88, notes: 'Employee-owned. Lifetime warranty. Handbuilt in Colorado.' },
    { name: 'Seven Cycles', country: 'USA (Watertown, MA)', material: 'Titanium/Steel', karma_score: 85, notes: 'Custom geometry, made to your measurements. New England made.' },
    { name: 'Breadwinner Cycles', country: 'USA (Portland, OR)', material: 'Steel/Titanium', karma_score: 82, notes: 'Small batch, artisan builders. Carbon-neutral workshop.' },
    { name: 'Lynskey Performance', country: 'USA (Chattanooga, TN)', material: 'Titanium', karma_score: 80, notes: 'Tennessee-made titanium. Lifetime frame warranty.' },
    { name: 'Chumba USA', country: 'USA (Austin, TX)', material: 'Steel/Titanium', karma_score: 79, notes: 'MTB-focused custom builder. Small, passionate team.' },
  ],
  wheels: [
