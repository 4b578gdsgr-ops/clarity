...
// Returns 'bike' or 'bikes' based on the bikes array length
...
export async function sendServiceEmail(trigger, booking) {
  ...
  switch (trigger) {
    ...
    case 'in_progress': {
      subject = `Your ${bikeNoun(booking)} ${bikeVerb(booking)} with us`;
      text = [
        `Hi ${name},`,
        '',
        `Your ${bikeNoun(booking)} ${bikeVerb(booking)} with us. We'll keep you posted.`,
        '',
        `Track your service: ${link}`,
        '',
        '— One Love Outdoors',
    ...
    case 'done': {
      ...
      subject = `Your ${bikeNoun(booking)} ${bikeVerb(booking)} ready`;
      const hasPayment = booking.invoice_amount != null && booking.payment_link;
      if (hasPayment) {
        text = [
          `Hi ${name},`,
          '',
          `Your ${bikeNoun(booking)} ${bikeVerb(booking)} ready.`,
          '',
        ...
        text = [
          `Hi ${name},`,
          '',
          `Your ${bikeNoun(booking)} ${bikeVerb(booking)} ready to go. We'll deliver it on ${returnDate}.`,
          '',
          `Track your service: ${link}`,
          '',
          '— One Love Outdoors',
    ...
    case 'ready': {
      ...
      text = [
        `Hi ${name},`,
        '',
        `Your ${bikeNoun(booking)} ${bikeVerb(booking)} ready! We'll deliver it on ${returnDate}. We'll confirm an exact time closer to the day.`,
        '',
        ...(hasPayment ? [
          `Total: $${Number(booking.invoice_amount).toFixed(2)}`,
          '',
    ...
    case 'out_for_delivery': {
      ...
      subject = `Your ${bikeNoun(booking)} ${bikeVerb(booking)} on the way`;
      text = [
        `Hi ${name},`,
        '',
        `Your ${bikeNoun(booking)} ${bikeVerb(booking)} on the way back. See you${deliveryTime} today.`,
        '',
        `Track your service: ${link}`,
        '',
        '— One Love Outdoors',
