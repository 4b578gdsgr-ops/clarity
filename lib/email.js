...
export async function sendServiceEmail(trigger, booking) {
  ...
  switch (trigger) {
    ...
    case 'in_progress': {
      subject = "Your bike is with us";
      text = [
        `Hi ${name},`,
        '',
        `Your bike is with us. We'll keep you posted.`,
        '',
        `Track your service: ${link}`,
        '',
        '— One Love Outdoors',
    ...
    case 'ready': {
      ...
      text = [
        `Hi ${name},`,
        '',
        `Your ${bike} is ready! We'll deliver it on ${returnDate}. We'll confirm an exact time closer to the day.`,
        '',
        ...(hasPayment ? [
          `Total: $${Number(booking.invoice_amount).toFixed(2)}`,
          '',
    ...
    case 'out_for_delivery': {
      ...
      subject = 'Your bike is on its way';
      text = [
        `Hi ${name},`,
        '',
        `Your ${bike} is on its way back. See you${deliveryTime} today.`,
        '',
        `Track your service: ${link}`,
        '',
        '— One Love Outdoors',
