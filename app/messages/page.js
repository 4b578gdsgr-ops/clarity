...
export default function MessagesPage() {
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#fafaf7', display: 'flex', flexDirection: 'column' }}>
      <div style={{ maxWidth: 600, width: '100%', margin: '0 auto', flex: 1, display: 'flex', flexDirection: 'column', padding: '0 0 env(safe-area-inset-bottom)' }}>

        {/* Header */}
        <div style={{ padding: '24px 16px 16px' }}>
          <h1 style={{ fontFamily: 'Playfair Display, serif', fontSize: 26, color: '#0f1a14', margin: '0 0 6px' }}>
            Messages
          </h1>
        ...
        {messages.length > 0 && (
          <div
            ref={threadRef}
            style={{ flex: 1, overflowY: 'auto', padding: '8px 16px', display: 'flex', flexDirection: 'column', gap: 10 }}
          >
            {messages.map(msg => {
