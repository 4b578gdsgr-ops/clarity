  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 px-4 py-10 max-w-2xl mx-auto">
        ...
        {/* CTA — Square checkout if URL set, fallback form if not */}
          ...
          {CHECKOUT_URL ? (
            <div className="text-center">
              <a
                ...
                style={{ background: 'linear-gradient(135deg, #2d8653, #1a6e3f)', textDecoration: 'none' }}
              >
                Join — $25/month
              </a>
            ...
            <div className="px-5 py-6 rounded-2xl" style={{ background: '#ffffff', border: '1px solid #e5e0d8', boxShadow: '0 2px 24px rgba(45,134,83,0.07)' }}>
              {sent ? (
